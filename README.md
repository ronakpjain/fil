...
six-board one-second workload took 1.82 s, 1.77 s, and 1.85 s while preserving the
exact 96,000,000 logical instruction/cycle total and per-board results—about 0.55x
