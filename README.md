...
command ran the corrected one-second workload in 0.87 s, 0.86 s, and 0.87 s while
preserving the exact 96,000,000 logical instruction/cycle total and per-board
results—about 1.15x real time with clock-timed ADC sequences and per-rank DMA
